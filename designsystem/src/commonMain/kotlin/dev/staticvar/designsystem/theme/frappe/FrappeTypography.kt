...
/**
 * Typography definitions for Frappé theme with harmonized color usage.
 *
 * Mirrors the Catppuccin guidance: strongest contrast for upper hierarchy,
 * stepping down through body and label tokens for supporting text.
 */
internal object FrappeTypography {
  fun createTokens(
