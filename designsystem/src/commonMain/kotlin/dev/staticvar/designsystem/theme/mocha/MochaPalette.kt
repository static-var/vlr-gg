...
/**
 * Maps Catppuccin Mocha's 26 colors to the standard Prism color palette.
 *
 ...
 */
internal object MochaPalette {
  fun create(tokens: MochaColorTokens = MochaColorTokens()): PrismColorPalette {
    return PrismColorPalette(
      // Backgrounds - Mocha uses dark base colors
