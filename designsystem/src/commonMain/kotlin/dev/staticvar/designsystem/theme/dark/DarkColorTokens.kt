...
internal data class DarkColorTokens(
  ...
  val textSecondary: Color = Color(0xFFC2C2C2),
  val textTertiary: Color = Color(0xFFA3A3A3),
  val accent: Color = Color(0xFFA78BFA),
  val accentHover: Color = Color(0xFFC4B5FD),
  val accentMuted: Color = Color(0xFF2D2442),
  val border: Color = Color(0xFF737373),
  val borderStrong: Color = Color(0xFFD4D4D4),
