...
/**
 * Maps Catppuccin Frappé's 26 colors to the standard Prism color palette.
 *
 ...
 */
internal object FrappePalette {
  fun create(tokens: FrappeColorTokens = FrappeColorTokens()): PrismColorPalette {
    return PrismColorPalette(
      // Backgrounds - Frappé uses dark base colors
