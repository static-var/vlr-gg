...
/**
 * Builds Material3 ColorScheme from Prism color palette for Mocha theme.
 *
 * Maps semantic design tokens to Material3's standard color roles.
 * Since Mocha is a dark theme, this uses [darkColorScheme].
 */
internal object MochaColorScheme {
