...
/**
 * Builds Material3 ColorScheme from Prism color palette for Macchiato theme.
 *
 * Maps semantic design tokens to Material3's standard color roles.
 * Since Macchiato is a dark theme, this uses [darkColorScheme].
 */
internal object MacchiatoColorScheme {
