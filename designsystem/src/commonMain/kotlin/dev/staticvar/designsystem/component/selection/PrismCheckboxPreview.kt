...
@PrismPreview
@Composable
internal fun PrismCheckboxPreview(@PreviewParameter(PrismPreviewProvider::class) variant: PrismVariant) {
  PrismTheme(variant = variant) {
    ...
    Column(
      ...
      Row(horizontalArrangement = Arrangement.spacedBy(Prism.dimens.spacingS)) {
        PrismCheckbox(checked = false, onCheckedChange = {})
        PrismCheckbox(checked = true, onCheckedChange = {})
        PrismCheckbox(checked = false, onCheckedChange = {}, enabled = false)
        PrismCheckbox(checked = true, onCheckedChange = {}, enabled = false)
      }
    }
  }
}
