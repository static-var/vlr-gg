...
import dev.staticvar.designsystem.components.RadioButtonDefaults.MinimumInteractiveSize
import dev.staticvar.designsystem.components.RadioButtonDefaults.RadioAnimationDuration
import dev.staticvar.designsystem.components.RadioButtonDefaults.RadioButtonIconSize
import dev.staticvar.designsystem.components.RadioButtonDefaults.RadioButtonPadding
import dev.staticvar.designsystem.components.RadioButtonDefaults.RadioSelectedStrokeWidth
import dev.staticvar.designsystem.components.RadioButtonDefaults.RadioStrokeWidth
...
object RadioButtonDefaults {
    ...
    fun colors() =
        RadioButtonColors(
            selectedColor = LucidTheme.colors.primary,
            unselectedColor = LucidTheme.colors.primary,
            disabledSelectedColor = LucidTheme.colors.disabled,
            disabledUnselectedColor = LucidTheme.colors.disabled,
        )
}
