package dev.staticvar.designsystem.components.card
...
import dev.staticvar.designsystem.LocalTypography
...
object CardDefaults {
    ...
    fun cardColors(
        ...
        contentColor: Color = LucidTheme.colors.onSurface,
        disabledContainerColor: Color =
            LucidTheme.colors.disabled,
        disabledContentColor: Color = LucidTheme.colors.onDisabled,
    ): CardColors =
        CardColors(
    ...
    fun elevatedCardColors(
        ...
        contentColor: Color = LucidTheme.colors.onBackground,
        disabledContainerColor: Color =
            LucidTheme.colors.disabled,
        disabledContentColor: Color = LucidTheme.colors.onDisabled,
    ): CardColors =
