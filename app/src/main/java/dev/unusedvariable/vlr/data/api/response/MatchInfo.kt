...
data class MatchInfo(
    ...
    var id: String = "",
    @SerialName("data")
    val matchData: List<MatchDetailData> = listOf(),
    @SerialName("event")
    val event: Event = Event(),
    @SerialName("previous_encounters")
    ...
    data class MatchDetailData(
        ...
        data class Member(
            ...
            @SerialName("deaths")
            val deaths: Int = 0, // 18
            @SerialName("headshot_percent")
            val hsPercent: Int = 0, // 127
            @SerialName("kills")
            val kills: Int = 0, // 20
            @SerialName("name")
    ...
    data class Videos(
        @SerialName("streams")
        val streams: List<ReferenceVideo> = listOf(),
        @SerialName("vods")
        val vods: List<ReferenceVideo> = listOf(),
    ) {
