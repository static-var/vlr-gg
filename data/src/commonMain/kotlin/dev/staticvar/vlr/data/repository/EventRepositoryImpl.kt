...
internal class EventRepositoryImpl(
  ...
  override fun getEvents(): Flow<List<EventPreview>> =
    eventsQueries
  ...
  override suspend fun addToFavorites(eventId: String): Result<Unit> =
  ...
  override suspend fun removeFromFavorites(eventId: String): Result<Unit> =
    withContext(dispatchers.io) {
      runCatching {
  ...
  private fun mergeEventListEntity(
    entity: Events,
    current: GetEventsWithFavoriteStatus?
  ): Events {
