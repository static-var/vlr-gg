...
internal class PlayerRepositoryImpl(
  ...
  override fun getPlayerInTeam(teamId: String): Flow<List<PlayerInfo?>> =
    playersQueries
  ...
  override suspend fun addToFavorites(playerId: String): Result<Unit> =
  ...
  override suspend fun removeFromFavorites(playerId: String): Result<Unit> =
    withContext(dispatchers.io) {
      runCatching {
