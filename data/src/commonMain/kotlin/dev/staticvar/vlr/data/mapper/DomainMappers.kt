 ...
 */
internal fun News.toNewsItem(): NewsItem =
  NewsItem(
    id = id,
    url = url,
    title = title,
 ...
 */
internal fun aggregateNewsArticle(
  news: News,
...
private fun Team_roster.toTeamPlayer(): TeamPlayer =
  TeamPlayer(
    id = player_id,
    name = player_name,
    alias = player_name,
...
private fun Team_upcoming_matches.toDomain(): TeamUpcomingMatch =
  TeamUpcomingMatch(
    matchId = match_id,
...
private fun PlayerTeamHistory.toPlayerTeam(): PlayerTeam =
  PlayerTeam(
    id = team_id,
    name = team_name,
...
private fun PlayerAgentStats.toDomain(): PlayerAgentStat =
  PlayerAgentStat(
 ...
 */
internal fun List<Rankings>.toRegionalRankings(): List<RegionalRanking> =
  groupBy { it.region }
    .map { (region, rankings) ->
      RegionalRanking(
        region = region,
 ...
 */
internal fun GetEventsWithFavoriteStatus.toEventPreview(): EventPreview =
  EventPreview(
    id = id,
    title = name,
...
private fun EventPrizes.toDomain(): EventPrize =
  EventPrize(
    position = position,
    prize = prize,
...
private fun EventTeams.toDomain(): EventTeam =
  EventTeam(
    id = team_id,
    name = team_name,
    logoUrl = team_logo_url,
...
private fun EventStandings.toDomain(): EventStanding =
  EventStanding(
    teamName = team_name,
