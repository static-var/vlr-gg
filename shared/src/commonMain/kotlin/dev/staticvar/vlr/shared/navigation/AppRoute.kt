...
public sealed interface AppRoute : NavKey {
  ...
  @Serializable
  public data object DeveloperNote : AppRoute
  ...
  @Serializable
  public data object Experimental : AppRoute
...
public val AppRoute.rootDestination: AppRoute
  get() =
    when (this) {
      ...
      AppRoute.About, AppRoute.DeveloperNote, AppRoute.WhatsNew, AppRoute.Appearance, AppRoute.Experimental -> AppRoute.Settings
