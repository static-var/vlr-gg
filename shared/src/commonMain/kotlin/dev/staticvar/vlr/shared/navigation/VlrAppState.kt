    ...
    serializersModule =
      SerializersModule {
        polymorphic(NavKey::class) {
          ...
          subclass(AppRoute.DeveloperNote::class, AppRoute.DeveloperNote.serializer())
...
public class VlrAppState internal constructor(
  ...
  public fun showExperimental() {
    pushRoute(route = AppRoute.Experimental)
  }

  public fun showAppearance() {
    pushRoute(route = AppRoute.Appearance)
  }

  public fun showWhatsNew() {
    pushRoute(route = AppRoute.WhatsNew)
  }

  public fun showDeveloperNote() {
    pushRoute(route = AppRoute.DeveloperNote)
  }
